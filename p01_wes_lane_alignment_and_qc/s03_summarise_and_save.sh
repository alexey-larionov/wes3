...
# Update pipeline log
echo "Started making summaries and plots: $(date +%d%b%Y_%H:%M:%S)" >> "${pipeline_log}"

# ------------------------------------------------- #
#         Set environment and start job log         #
# ------------------------------------------------- #

echo "Making summary plots and saving results for wes lane alignment and QC"
...
title="${project} ${library} ${lane}: Samtools flagststs"
ylabel="Read counts"
...
title="${project} ${library} ${lane}: Duplication rates"
ylabel="Fractoin"
...
title="${project} ${library} ${lane}: picard AS-metrics and mkdup"
ylabel="Read counts"
...
title="${project} ${library} ${lane}: Selected and on target bases"
...
title="${project} ${library} ${lane}: Bases covered at x-fold"
...
title="${project} ${library} ${lane}: Enrichment efficiency"
ylabel="Fold"
...
title="${project} ${library} ${lane}: Mean target coverage"
ylabel="Fold"
...
echo "Completed summaries and plots: $(date +%d%b%Y_%H:%M:%S)"
echo ""

# Update pipeline log
echo "Completed making summaries and plots: $(date +%d%b%Y_%H:%M:%S)" >> "${pipeline_log}"
echo "" >> "${pipeline_log}"
